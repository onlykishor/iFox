SendSmtpEmail('smtp.ifox.in','info@ifox.in','onlykishor@gmail.com','Subject','Message')
...
DO WHILE .T. && Control Loop
  ...
  if not ReadWrite(sock,"EHLO" + alltrim(strServ), 220)
    GiveFeedBack( loFB, "Failed EHLO" )
    EXIT && Leave Control Loop
  endif
